...
export default function QueSidra(primary) {
    ...
    return (
        <div id="quesidra" className="max-w-small md:max-w-design mx-auto">
            <div className="mb-20" >
                <div className="md:mx-auto my-12 md:my-20 md:w-5/6  flex grid grid-cols-1 md:grid-cols-2 md:space-x-20">
