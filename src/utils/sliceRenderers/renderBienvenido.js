        ...
        <div id="bienvenido ">
            ...
            >
                <div className="max-w-small md:max-w-design mx-auto">
                    <div className="md:mx-auto md:w-5/6 text-4xl md:text-5xl lg:text-6xl font-bold   pt-12 pb-4 md:pt-20 md:pb-20 text-yellow-150">
                ...
                <div className="max-w-small md:max-w-design m-auto my-4 md:my-20 flex flex-row pb-12 md:pb-20 justify-items-start" >
                    ...
                    <div className="flex flex-row md:mx-auto md:w-5/6 ">
