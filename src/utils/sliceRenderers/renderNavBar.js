        ...
        return (
            <div>
                ...
                >
                    ...
                    <div className="max-w-small md:max-w-design mx-auto mr-20">
                        <div className="h-4"></div>

                        <div className="justify-end space-x-1 h-20 navbar flex flex-row">
                            {items.map((item, i) => {
                                let itemStyle
                                if (item.label_link.text === 'PUNTOS DE VENTA') {
                                    itemStyle = 'py-2 px-4 text-white hover:text-green-apple bg-yellow-50 bg-opacity-60 font-bold rounded-lg hover:bg-opacity-100'
                                } else if (item.label_link.text === 'OFERTAS') {
                                    itemStyle = 'text-red-alert hover:text-yellow-50 font-bold pb-4  pr-8 h-full'
                                } else {
                                    itemStyle = 'pb-4  pr-8 h-full colorTrans font-semibold'
                                }
                                return (<div>
